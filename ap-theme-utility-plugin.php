...
if(!class_exists('APTU_Class')) :
	...
	class APTU_Class extends AP_APTU_Import {
		...
		public function demo_importer() {
			$demos = $this->demos;
			?>
				<h3 class="choose-demo-title"><?php echo esc_html__("Choose any one demo from the avaialable following demos !", APTU_TD ); ?></h3>
                <?php if(!empty($demos)) : ?>
                        ...
                        <div class="demo">
                            ...
                            <div class="demoinstall-title-btn-wrap clearfix">
            					...
            					<div class="demo-install-button">
            						<a data-menu="<?php echo $men; ?>"  data-homepage="<?php echo $demo['home_page']; ?>" data-folder="<?php echo esc_attr($demo['name']); ?>" class="button demo_import_btn" href="javascript(void);"><?php echo esc_html__('Install Demo', APTU_TD) ?></a>
            					</div>
                            </div>
                        </div>
    				<?php endforeach; ?>
